...
export const questionsList:any = {
  ...
  "Cost Compliance": "Need insights on your governance metrics? I can help you understand the month-over-month changes and key trends.",
  "Security Compliance": "Need insights on your governance metrics? I can help you understand the month-over-month changes and key trends.",
